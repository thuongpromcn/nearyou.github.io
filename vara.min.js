...
return _typeof="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(a){return typeof a}:function(a){return a&&"function"==typeof Symbol&&a.constructor===Symbol&&a!==Symbol.prototype?"symbol":typeof a},_typeof(a)}var Vara=function(a,b,c,d){var e=this;
    this.elementName=a,this.textsInit=[],"string"==typeof c?this.textsInit.push({text:c}):"object"==_typeof(c)&&(this.textsInit=c),this.texts=this.textsInit,this.properties=d||{},this.properties.textAlign=this.properties.textAlign||"left",this.letterSpacing=0,this.element=document.querySelector(this.elementName),this.fontSource=b,this.characters={},this.drawnCharacters={},this.totalPathLength=0,this.fontSize=24,this.frameRate=1e3/30,this.prevDuration=0,this.completed=!1,this.ready=function(a){e.readyF=a},this.animationEnd=function(a){e.animationEndF=a},this.svg=this.createNode("svg",{width:"100%"}),this.element.appendChild(this.svg),this.font=document.createElement("object"),this.getSVGData()};Vara.prototype.createNode=function(a,b){for(var c in a=document.createElementNS("http://www.w3.org/2000/svg",a),b)a.setAttributeNS(null,c.replace(/[A-Z]/g,function(a){return"-"+a.toLowerCase()}),b[c]);
    return a},Vara.prototype.getSVGData=function(){var a=this,b=new XMLHttpRequest;
